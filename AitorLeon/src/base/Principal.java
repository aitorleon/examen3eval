...
public class Principal {
	...
	private static void mostrarMenu(int nivel) {
		...
		do {
			...
			LOGGER.log(Level.FINE, "Aukera: " + opcion);
	...
	/**
	 * Este metodo recibe un numero entero y devuelve un booleano dependiendo de este
	 * @author Aitor Leon
	 * @param nivel Recibe un numero entero
	 * @return Devuelve un booleano que puede ser true o false
	 */
